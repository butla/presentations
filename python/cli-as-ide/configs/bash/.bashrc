...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\] \[\033[01;34m\]\w\[\033[1;35m\]$(__git_ps1 " (%s)")\n\[\033[01;32m\]\$\[\033[00m\] '
else
...
# setting up virtualenvwrapper for Python
export VIRTUALENVWRAPPER_PYTHON=/usr/bin/python3
source $HOME/.local/bin/virtualenvwrapper.sh

# NPM setup; enables "global" installation of packages for the user
...
# make locally installed Ruby Gems runnable
...
export GOOGLE_APPLICATION_CREDENTIALS=$HOME/.config/gcloud/Intervention-57e78619e886.json
